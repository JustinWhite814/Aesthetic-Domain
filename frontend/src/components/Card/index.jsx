...
export default function Card({ artworkData, updateDetails }) {
    return (
        ...
        >
            <figure className="text-center m-2 border-2 border-black rounded-lg cursor-pointer bg-black-700 bg-opacity-70 text-gray-300 hover:text-white hover:bg-blue-800 hover:transform hover:scale-105 shadow-lg transition ease duration-50">
